...
<head>
    ...
    <link rel="stylesheet" href='/authSystem/style.css'>

    <title>Login to PFT</title>
</head>
...
<body>
        ...
        <div class="form-container sign-up">
            <form action="{{ route('register') }}" method="post">
                ...
                @error('password')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                <input type="password" placeholder="Re-typed Password" name="password_confirmation"
    ...
    <script src='authSystem/script.js'></script>
